...
export const initPagination = ({ pages, fromRow, toRow, totalRows }, createPage) => {
    ...
    // @todo: Сформировать параметры пагинации до получения данных
    ...
    // @todo: Перерисовать пагинатор после получения данных
    ...
    return {
        updatePagination,                                               // Вместо возврата одной функции мы теперь возвращаем две
        applyPagination
    }
}